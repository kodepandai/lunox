...
<div class="bg-secondary min-h-screen relative">
    <main
        class="mx-auto container py-10 xl:px-30 lg:px-10 px-4 font-sans pb-15 justify-center flex flex-col min-h-screen"
    >
        <LightSwitch class="absolute top-5 right-5"/>
        <slot />
        <footer
